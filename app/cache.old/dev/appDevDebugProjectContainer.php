...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $c = new \Assetic\Cache\ConfigCache('C:/Users/spl01001/workspace/dashboard-portal_DEV/app/cache/dev/assetic/config');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, '', 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, '', 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/Resources/views', '/\\.[^.]+\\.php$/'), 'php');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/Resources');
    ...
    protected function getDoctrine_Orm_CsiOldEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_CSI_OLD_78f09307240f9ec7ee62bd8aad7eceaad77d0528e82c909fc1e754f13aeb4999');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_CSI_OLD_78f09307240f9ec7ee62bd8aad7eceaad77d0528e82c909fc1e754f13aeb4999');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_CSI_OLD_78f09307240f9ec7ee62bd8aad7eceaad77d0528e82c909fc1e754f13aeb4999');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\src\\DBORM\\OLDCSIBundle\\Entity')), 'DBORM\\OLDCSIBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('DBORMOLDCSIBundle' => 'DBORM\\OLDCSIBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('C:/Users/spl01001/workspace/dashboard-portal_DEV/app/cache/dev/doctrine/orm/Proxies');
        ...
        $this->services['doctrine.orm.csi_old_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create($this->get('doctrine.dbal.csi_old_connection'), $e);
    ...
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_78f09307240f9ec7ee62bd8aad7eceaad77d0528e82c909fc1e754f13aeb4999');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_78f09307240f9ec7ee62bd8aad7eceaad77d0528e82c909fc1e754f13aeb4999');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_78f09307240f9ec7ee62bd8aad7eceaad77d0528e82c909fc1e754f13aeb4999');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\src\\DBORM\\CSIBundle\\Entity')), 'DBORM\\CSIBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('DBORMCSIBundle' => 'DBORM\\CSIBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        ...
        $this->services['doctrine.orm.default_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create($this->get('doctrine.dbal.csi_dev_connection'), $e);
    ...
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_KLM_RM_78f09307240f9ec7ee62bd8aad7eceaad77d0528e82c909fc1e754f13aeb4999');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_KLM_RM_78f09307240f9ec7ee62bd8aad7eceaad77d0528e82c909fc1e754f13aeb4999');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_KLM_RM_78f09307240f9ec7ee62bd8aad7eceaad77d0528e82c909fc1e754f13aeb4999');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\src\\DBORM\\KLMBundle\\Entity')), 'DBORM\\KLMBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('DBORMKLMBundle' => 'DBORM\\KLMBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        ...
        $this->services['doctrine.orm.klm_rm_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create($this->get('doctrine.dbal.klm_rm_connection'), $e);
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/Users/spl01001/workspace/dashboard-portal_DEV/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/Users/spl01001/workspace/dashboard-portal_DEV/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'yaml'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/Users/spl01001/workspace/dashboard-portal_DEV/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/Users/spl01001/workspace/dashboard-portal_DEV/app');
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/Users/spl01001/workspace/dashboard-portal_DEV/app/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/Users/spl01001/workspace/dashboard-portal_DEV/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\src\\RMCARGO\\DashboardFABundle/Resources/views', 'RMCARGODashboardFA');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\src\\RMCARGO\\DashboardAdminBundle/Resources/views', 'RMCARGODashboardAdmin');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\src\\General\\LoginBundle/Resources/views', 'GeneralLogin');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\src\\RMCARGO\\DashboardChiefSectorBundle/Resources/views', 'RMCARGODashboardChiefSector');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\src\\RMCARGO\\DashboardRHBundle/Resources/views', 'RMCARGODashboardRH');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\src\\DBORM\\CSIBundle/Resources/views', 'DBORMCSI');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\src\\DBORM\\OLDCSIBundle/Resources/views', 'DBORMOLDCSI');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\src\\General\\WidgetBundle/Resources/views', 'GeneralWidget');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\src\\Price\\DashboardAdminBundle/Resources/views', 'PriceDashboardAdmin');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\src\\RMCCCAction\\RMCCCBundle/Resources/views', 'RMCCCActionRMCCC');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\src\\DBORM\\KLMBundle/Resources/views', 'DBORMKLM');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/Users/spl01001/workspace/dashboard-portal_DEV/app/Resources/views');
        $instance->addPath('C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'C:\\Users\\spl01001\\workspace\\dashboard-portal_DEV\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/Users/spl01001/workspace/dashboard-portal_DEV/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/cache/dev',
            'kernel.logs_dir' => 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/logs',
            ...
            'database_host' => 'Zma02vvqfptp\\DPS_SERVER',
            'database_port' => NULL,
            ...
            'debug.container.dump' => 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/Users/spl01001/workspace/dashboard-portal_DEV/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/../web',
            'assetic.write_to' => 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/Users/spl01001/workspace/dashboard-portal_DEV/app/cache/dev/doctrine/orm/Proxies',
