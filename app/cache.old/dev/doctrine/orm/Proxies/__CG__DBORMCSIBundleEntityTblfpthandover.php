...
class Tblfpthandover extends \DBORM\CSIBundle\Entity\Tblfpthandover implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function getDayFlightDoneBySubSec($sector)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDayFlightDoneBySubSec', array($sector));

        return parent::getDayFlightDoneBySubSec($sector);
    }
