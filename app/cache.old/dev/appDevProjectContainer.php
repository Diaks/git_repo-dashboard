...
class appDevProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/cache/dev/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $a = $this->get('assetic.asset_factory');
        $b = $this->get('templating.loader');
        $c = new \Assetic\Cache\ConfigCache('C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/cache/dev/assetic/config');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, '', 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, '', 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/Resources/views', '/\\.[^.]+\\.php$/'), 'php');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/Resources');
    ...
    {
        return $this->services['doctrine'] = new \Doctrine\Bundle\DoctrineBundle\Registry($this, array('CSI_OLD' => 'doctrine.dbal.CSI_OLD_connection', 'CSI_DEV' => 'doctrine.dbal.CSI_DEV_connection', 'idefix_cafeed' => 'doctrine.dbal.idefix_cafeed_connection'), array('default' => 'doctrine.orm.default_entity_manager', 'CSI_OLD' => 'doctrine.orm.CSI_OLD_entity_manager'), 'CSI_DEV', 'default');
    }
    ...
    {
        return $this->services['doctrine.dbal.csi_dev_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_sqlsrv', 'host' => 'Zma02vvqfptp\\DPS_SERVER', 'port' => NULL, 'dbname' => 'CSI_DEV', 'user' => 'DPS_User', 'password' => 'CargoFPT', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Dbal_CsiOldConnectionService()
    {
        return $this->services['doctrine.dbal.csi_old_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_sqlsrv', 'host' => 'Zma02vvqfptp\\DPS_SERVER', 'port' => NULL, 'dbname' => 'CSI', 'user' => 'DPS_User', 'password' => 'CargoFPT', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_CsiOldEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_CSI_OLD_63d6a1707612d67482f19413f9954fcaa425fbc09eeb88f7271dab429ca34293');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_CSI_OLD_63d6a1707612d67482f19413f9954fcaa425fbc09eeb88f7271dab429ca34293');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_CSI_OLD_63d6a1707612d67482f19413f9954fcaa425fbc09eeb88f7271dab429ca34293');
        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\src\\DBORM\\OLDCSIBundle\\Entity')), 'DBORM\\OLDCSIBundle\\Entity');
        ...
        $e->setProxyDir('C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_63d6a1707612d67482f19413f9954fcaa425fbc09eeb88f7271dab429ca34293');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_63d6a1707612d67482f19413f9954fcaa425fbc09eeb88f7271dab429ca34293');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_63d6a1707612d67482f19413f9954fcaa425fbc09eeb88f7271dab429ca34293');
        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\src\\DBORM\\CSIBundle\\Entity')), 'DBORM\\CSIBundle\\Entity');
        $e = new \Doctrine\ORM\Configuration();
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/cache/dev/profiler', '', '', 86400), $a);
        $instance->add($c);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/cache/dev/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\src\\RMCARGO\\DashboardFABundle/Resources/views', 'RMCARGODashboardFA');
        $instance->addPath('C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\src\\RMCARGO\\DashboardAdminBundle/Resources/views', 'RMCARGODashboardAdmin');
        $instance->addPath('C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\src\\General\\LoginBundle/Resources/views', 'GeneralLogin');
        $instance->addPath('C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\src\\RMCARGO\\DashboardChiefSectorBundle/Resources/views', 'RMCARGODashboardChiefSector');
        $instance->addPath('C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\src\\RMCARGO\\DashboardRHBundle/Resources/views', 'RMCARGODashboardRH');
        $instance->addPath('C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\src\\DBORM\\CSIBundle/Resources/views', 'DBORMCSI');
        $instance->addPath('C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\src\\DBORM\\OLDCSIBundle/Resources/views', 'DBORMOLDCSI');
        $instance->addPath('C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\src\\General\\WidgetBundle/Resources/views', 'GeneralWidget');
        $instance->addPath('C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/Resources/views');
        $instance->addPath('C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
        return $instance;
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'C:\\Program Files\\EasyPHP-Webserver-14.1b2\\www\\dashboard-portal_DEV\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/../web', false);
        $instance->addWorker(new \Symfony\Bundle\AsseticBundle\Factory\Worker\UseControllerWorker());
        return $instance;
    }
    protected function getAssetic_CacheService()
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => false,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/cache/dev',
            'kernel.logs_dir' => 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/logs',
            ...
            'session.save_path' => 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/sessions/',
            ...
            'profiler.storage.dsn' => 'file:C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/../web',
            'assetic.write_to' => 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/../web',
            'assetic.variables' => array(
            ),
            'assetic.java.bin' => 'd:\\Documents and Settings\\All Users\\Application Data\\Oracle\\Java\\javapath\\java.EXE',
            ...
            'doctrine.orm.proxy_dir' => 'C:/Program Files/EasyPHP-Webserver-14.1b2/www/dashboard-portal_DEV/app/cache/dev/doctrine/orm/Proxies',
